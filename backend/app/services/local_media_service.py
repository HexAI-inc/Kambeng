...
class LocalMediaService:
    ...
    def save_campaign_image(self, campaign_id: int, original_filename: str, content: bytes, content_type: str) -> Dict[str, str | int]:
    ...
    def save_kyc_document(self, user_id: int, document_type, file_content: bytes, file_extension: str) -> str:
