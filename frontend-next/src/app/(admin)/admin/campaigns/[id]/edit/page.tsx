      ...
      <div style={{ maxWidth: 720, margin: "0 auto", display: "flex", flexDirection: "column", gap: 20 }}>
        ...
        <motion.div initial={{ opacity: 0, y: 14 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.35 }}>
          <div style={{ display: "flex", alignItems: "center", gap: 12 }}>
            ...
            <div style={{ fontSize: 22, fontWeight: 900, color: "#15201a", letterSpacing: "-0.03em" }}>Edit Campaign #{campaignId}</div>
          </div>
        </motion.div>

        <div style={{ background: "#ffffff", border: "1px solid rgba(21,32,26,0.07)", borderRadius: 16, padding: "24px", display: "flex", flexDirection: "column", gap: 16 }}>
          ...
          {/* Editable: status */}
          <div>
            <div style={{ fontSize: 11, fontWeight: 700, color: "#56625b", textTransform: "uppercase", letterSpacing: "0.07em", marginBottom: 8 }}>Campaign Status</div>
                ...
                return (
                  <button
                    ...
                    style={{
                      ...
                      border: `1px solid ${isSelected ? c.border : "rgba(21,32,26,0.1)"}`,
                      background: isSelected ? c.bg : "rgba(21,32,26,0.04)",
                      color: isSelected ? c.color : "#56625b",
                    }}
                  >{s}</button>
                );
              })}
        ...
        <div style={{ display: "flex", gap: 10 }}>
          <button
            ...
            style={{ padding: "11px 24px", borderRadius: 9, border: "none", background: `${BLUE}`, color: "#fff", fontSize: 13, fontWeight: 700, cursor: "pointer", boxShadow: "0 4px 16px rgba(20,120,74,0.3)" }}
          >
