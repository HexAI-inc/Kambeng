      ...
      <div style={{ width: "100%", maxWidth: 440, position: "relative", zIndex: 1 }}>
        ...
        <div style={{ background: "#ffffff", border: "1px solid rgba(21,32,26,0.08)", borderRadius: 20, padding: "32px", boxShadow: "0 24px 80px rgba(21,32,26,0.12)" }}>
          <div style={{ marginBottom: 24 }}>
            <div style={{ fontSize: 22, fontWeight: 900, color: "#15201a", letterSpacing: "-0.03em", marginBottom: 6 }}>Reset your password</div>
            <div style={{ fontSize: 13, color: "#626d66" }}>Enter your email and we&apos;ll send you a reset link.</div>
          </div>

          {sent ? (
            <div style={{ padding: "16px", borderRadius: 10, background: "rgba(31,153,96,0.08)", border: "1px solid rgba(31,153,96,0.2)", color: "#1f9960", fontSize: 13, textAlign: "center" }}>
            ...
            <form onSubmit={(e) => void onSubmit(e)} style={{ display: "flex", flexDirection: "column", gap: 16 }}>
              ...
              {submitError && (
                <div style={{ padding: "10px 14px", borderRadius: 8, background: "rgba(239,68,68,0.08)", border: "1px solid rgba(239,68,68,0.2)", fontSize: 13, color: "#b42323" }}>{submitError}</div>
              )}
              ...
              <div style={{ display: "flex", gap: 10 }}>
                <Link href="/auth/login" style={{ flex: 1 }}>
                  <button type="button" style={{ width: "100%", padding: "10px", borderRadius: 9, border: "1px solid rgba(21,32,26,0.1)", background: "rgba(21,32,26,0.04)", color: "#56625b", fontSize: 13, fontWeight: 600, cursor: "pointer" }}>Back to Login</button>
                </Link>
                <Link href="/auth/signup" style={{ flex: 1 }}>
                  <button type="button" style={{ width: "100%", padding: "10px", borderRadius: 9, border: "1px solid rgba(21,32,26,0.1)", background: "rgba(21,32,26,0.04)", color: "#56625b", fontSize: 13, fontWeight: 600, cursor: "pointer" }}>Create Account</button>
                </Link>
              </div>
            </form>
          )}
