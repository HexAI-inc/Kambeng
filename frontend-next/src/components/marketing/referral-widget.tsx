...
export default function ReferralWidget() {
  ...
  return (
    <div style={{ background: "#ffffff", border: "1px solid rgba(21,32,26,0.07)", borderRadius: 14, overflow: "hidden" }}>
      <div style={{ padding: "14px 18px", borderBottom: "1px solid rgba(21,32,26,0.05)" }}>
        <span style={{ fontSize: 11, fontWeight: 700, color: "#6e7872", letterSpacing: "0.08em", textTransform: "uppercase" }}>Invite organisers</span>
      </div>
      <div style={{ padding: "14px 18px" }}>
        <p style={{ margin: "0 0 12px", fontSize: 12, color: "#56625b", lineHeight: 1.6 }}>
        ...
        <div style={{ display: "flex", gap: 8 }}>
          ...
          <button
            ...
            style={{
              ...
              background: copied ? "rgba(31,153,96,0.15)" : `${BLUE}20`,
